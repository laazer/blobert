...
- M30_01_attack_resource_frame_data_extension (coordinate timing)

## Notes

- Charge curves allow non-linear scaling (e.g., rapid early gain, plateau late)
- Integration with M33 input buffering: don't lose charge on missed buffer window
- Integration with M37 UI: charge meter reflects current accumulation

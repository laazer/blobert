...
**Test Status:** All 12 tests currently FAIL (expected behavior)
...
**Next Action:** Implementation agent implements image texture data merging into the `_merge_features_for_slug()` function in `schema.py` to make these tests PASS.

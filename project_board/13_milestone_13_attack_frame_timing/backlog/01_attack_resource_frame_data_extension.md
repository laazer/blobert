...
**Milestone:** M13 Attack Frame Timing  
**Status:** Backlog  
**Type:** Implementation
...
Frame timing allows data-driven attack feel tuning and enables cancel windows for responsive combos (from M13 core_3).
...
- Cancel windows enable input buffering + combo flow (see M13_core_3)

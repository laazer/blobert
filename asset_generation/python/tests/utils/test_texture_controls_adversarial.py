"""Procedural texture presets — adversarial coercion and mutation-guard tests.

This file intentionally holds edge-case tests that would otherwise push
`test_texture_controls.py` past the repo's per-module size cap.
"""
...
class TestGradDirectionCoercionAdversarial:
    ...
    def test_none_grad_direction_falls_back_to_horizontal(self) -> None:
        o = options_for_enemy("spider", {"texture_grad_direction": None})

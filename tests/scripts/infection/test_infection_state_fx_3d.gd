...
func _load_enemy_infection_3d_script() -> GDScript:
	return load("res://scripts/enemy/enemy_infection_3d.gd") as GDScript


func _load_infection_state_fx_3d_script() -> GDScript:
	return load("res://scripts/infection/infection_state_fx_3d.gd") as GDScript
...
func test_absorb_path_also_hides_enemy_node() -> void:
	...
	inventory.set_script(load("res://scripts/mutation/mutation_inventory.gd"))

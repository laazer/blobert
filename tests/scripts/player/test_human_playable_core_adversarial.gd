...
func _load_main_scene() -> Node:
	...
	if packed == null:
		_fail("adv_scene_load_main", "could not load res://scenes/levels/test_movement.tscn")
		return null
...
func test_chunk_visual_not_invisible_or_tiny() -> void:
	...
	if packed == null:
		_fail("adv_visual_chunk_scene_load", "could not load res://scenes/chunk/chunk.tscn")
		return

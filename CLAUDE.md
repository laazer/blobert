...
- **2D scenes:** `test_movement.tscn`, `player.tscn`, and related 2D assets are kept for existing headless tests; do not add new features to 2D. New tests should use the 3D scene (see `tests/scene/test_3d_scene.gd`).
